  ...
  return (
    <div className='h-screen bg-cyan-50 overflow-hidden relative'>
      ...
      <div className='container h-screen flex items-center justify-center px-20 mx-auto'>
        <div className='w-2/5 h-[90vh] flex items-end bg-[url(./src/assets/images/signup-bg-image.png)] bg-cover bg-center rounded-lg p-10 z-50'>
          <div>
          ...
          <div className='w-2/5 h-[75vh] bg-white rounded-r-lg relative p-16 shadow-lg shadow-cyan-200/20'>
            <form onSubmit={handleSignUp}>
              ...
              <button type='submit' className='btn-primary btn-light cursor-pointer' onClick={()=> {navigate("/login")}}>LOGIN</button>
            </form>
          </div>
      </div>
    </div>
